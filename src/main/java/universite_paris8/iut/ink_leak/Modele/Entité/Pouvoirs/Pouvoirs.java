...
public abstract class Pouvoirs extends Entité {
    ...
    public Pouvoirs(String nom_entite, int vie_entite, int attaque_entite, double largeur,double longueur, int vitesse_entite, long invincibilite, Map map, GenerateurEnnemis spawner, Joueur joueur) {
        super(nom_entite, vie_entite, attaque_entite, largeur,longueur, vitesse_entite, invincibilite, map, spawner);
        this.joueur = joueur;
    }
